#!/usr/bin/env python3
"""Run the fixed v7 harmonization smoke grid."""
...
CONFIGS = [
    ...
    ("02_lgbm_standard_p08_top1000_log1p", "lgbm", "standard", "0.8", "1000", "log1p_days"),
    ("03_lgbm_robust_p08_top1000_log1p", "lgbm", "robust", "0.8", "1000", "log1p_days"),
    ("04_lgbm_quantile_p08_top1000_log1p", "lgbm", "quantile_uniform", "0.8", "1000", "log1p_days"),
    ("05_ridge_robust_p08_top500_log1p", "ridge", "robust", "0.8", "500", "log1p_days"),
    ("06_elasticnet_robust_p08_top1000_log1p", "elasticnet", "robust", "0.8", "1000", "log1p_days"),
    ("07_lgbm_robust_p095_top1000_log1p", "lgbm", "robust", "0.95", "1000", "log1p_days"),
    ("08_lgbm_robust_p08_top1000_linear", "lgbm", "robust", "0.8", "1000", "linear_weeks"),
]
...
def main() -> None:
    ...
    parser.add_argument("--out_root", default=str(ROOT / "results" / "benchmark_v7_harmonization"))
    ...
    summary.to_csv(out_root / "v7_smoke_summary.tsv", sep="\t", index=False)
