#!/usr/bin/env python3
"""Run v7.6 coverage-weighted matrix smoke configs."""
...
CONFIGS = [
    {
        "name": "01_weighted_v74_robust_p095_top1000",
        "model": "lgbm",
        "preprocess": "robust",
        "presence": "0.95",
        "group_presence": "0.95",
    ...
    {
        "name": "02_weighted_v75_quantile_p08_top1000_agebin08",
        "model": "lgbm",
    ...
    {
        "name": "03_weighted_robust_p095_top1000_agebin095",
        "model": "lgbm",
        "preprocess": "robust",
        "presence": "0.95",
        "group_presence": "0.95",
    ...
    {
        "name": "04_weighted_standard_p05_top500",
        "model": "lgbm",
        "preprocess": "standard",
        "presence": "0.5",
        "group_presence": None,
...
def main() -> None:
    ...
    parser.add_argument(
        "--matrix",
        default=str(ROOT / "results" / "multidataset_v7_6_weighted" / "all_rrbs_region_matrix_5kb.parquet"),
    )
    parser.add_argument(
        "--metadata_path",
        default=str(ROOT / "metadata" / "model_sample_metadata_v7_1.csv"),
    )
    parser.add_argument("--out_root", default=str(ROOT / "results" / "benchmark_v7_6_coverage_weighted"))
    ...
    summary.to_csv(out_root / "v7_6_weighted_summary.tsv", sep="\t", index=False)
